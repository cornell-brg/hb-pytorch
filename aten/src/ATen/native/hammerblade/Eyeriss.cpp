...
static void hb_convolution_arg_check(
...
Tensor eyeriss_convolution_forward(
    CheckedFrom c,
  ...
  c10::hammerblade::offload_kernel(
      "tensorlib_eyeriss", device_args);
  cleanup_device(device_args, device_ptrs);

  return *output;
}

Tensor eyeriss_convolution(
  ...
  TensorArg input  { input_t,  "input",  1 },
            ...
            bias   { bias_t,   "bias",   3 };
  CheckedFrom c = "eyeriss_convolution";
  auto output_t = eyeriss_convolution_forward(
