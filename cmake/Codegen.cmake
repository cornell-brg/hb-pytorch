...
if (INTERN_BUILD_ATEN_OPS)
  ...
  file(READ ${CMAKE_BINARY_DIR}/aten/src/ATen/generated_cpp.txt-hammerblade hammerblade_generated_cpp)
  ...
  add_custom_command(OUTPUT ${generated_cpp} ${cuda_generated_cpp} ${core_generated_cpp} ${hammerblade_generated_cpp}
    COMMAND ${GEN_COMMAND}
  ...
  add_custom_target(ATEN_HAMMERBLADE_FILES_GEN_TARGET DEPENDS ${hammerblade_generated_cpp})
  add_library(ATEN_CPU_FILES_GEN_LIB INTERFACE)
  add_library(ATEN_CUDA_FILES_GEN_LIB INTERFACE)
  add_library(ATEN_HAMMERBLADE_FILES_GEN_LIB INTERFACE)
  ...
  add_dependencies(ATEN_HAMMERBLADE_FILES_GEN_LIB ATEN_HAMMERBLADE_FILES_GEN_TARGET)
endif()
