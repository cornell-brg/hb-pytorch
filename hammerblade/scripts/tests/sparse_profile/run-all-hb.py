...
#for i in [10,16,18]: # addmm & mm -- big
  ...
  print(sh_cmd)
  os.system(sh_cmd)
  script = "(cd " + name + "; pycosim -m pytest /scratch/users/zz546/pytorch-cosim/hb-pytorch/hammerblade/torch/tests/profiler/test_lenet5_sparseconv2_lowerspmm_profiler.py > out.std 2>&1)"
