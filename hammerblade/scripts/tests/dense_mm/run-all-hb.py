...
#  print(sh_cmd)
#  os.system(sh_cmd)
  script = "(cd " + name + "; pycosim -m pytest -vs /scratch/users/zz546/pytorch-cosim/hb-pytorch/hammerblade/torch/tests/profiler/test_dense_mm.py > out.std 2>&1)"
