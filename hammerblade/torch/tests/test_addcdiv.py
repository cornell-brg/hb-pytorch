"""
Unit tests for torch.addcdiv kernel
...
def test_torch_addcdiv_1():
    t1 = torch.ones(10)
    t2 = torch.ones(10)
    t3 = torch.ones(10)
    _test_torch_addcdiv(t1, t2, t3)

def test_torch_addcdiv_2():
    t1 = torch.randn(2, 3)
    t2 = torch.randn(2, 3)
    t3 = torch.randn(2, 3)
    _test_torch_addcdiv(t1, t2, t3)
...
def test_torch_addcdiv_hypothesis(tensors):
