...
torch.hammerblade.profiler.chart.add("at::Tensor at::TypeDefault::exp(const at::Tensor&)")
torch.hammerblade.profiler.chart.add("at::Tensor at::TypeDefault::cdist(const at::Tensor&, const at::Tensor&, double, c10::optional<long int>)")
torch.hammerblade.profiler.chart.add("at::Tensor at::CPUType::{anonymous}::gt(const at::Tensor&, c10::Scalar)")
