...
COSIM_PYTHON_EXE=/work/global/lc873/work/sdh/playground/hb_bigbladerunner/bigblade_toplevel/testing/rtl/out/cuda/simv
...
eval "$COSIM_PYTHON_EXE +ntb_random_seed_automatic +c_args=\""$@"\"" \
     "+c_path=/work/global/lc873/work/sdh/playground/hb_bigbladerunner/bigblade_toplevel/bsg_replicant/examples/python/test_loader/main.so " \
