...
extern "C" {
  ...
  __attribute__ ((noinline))  int tensorlib_sparse_add_out_dense(
          hb_tensor_t* _result,
          hb_tensor_t* _dense,
  ...
  HB_EMUL_REG_KERNEL(tensorlib_sparse_add_out_dense, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*, float*)
}
