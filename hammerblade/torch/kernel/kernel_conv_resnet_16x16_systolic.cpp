...
inline void imapDMA_padding_systolic(HBTensor<float, 4>& imap, float* imap_buf, size_t image_id, size_t channel_id, size_t block_x, size_t block_y) {
  ...
  // see if we need to add padding at top or bot
  switch (block_id) {
    case 0:
      addPaddingW_1(0);
...
extern "C" {
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_16x16_systolic(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
    ...
    auto imapDMA_job = [&]() {
      ...
      // we can do 4 images across 8 rows
      for (size_t image_id = image_offset; image_id < N; image_id+=4) {
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_16x16_back_input_systolic(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_16x16_back_weight_systolic(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
  ...
  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_16x16_systolic, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)

  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_16x16_back_input_systolic, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)

  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_16x16_back_weight_systolic, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)
