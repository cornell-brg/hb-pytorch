...
*/
  __attribute__ ((noinline))  int tensorlib_dstmmt(
  ...
  HB_EMUL_REG_KERNEL(tensorlib_dstmmt, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*)
