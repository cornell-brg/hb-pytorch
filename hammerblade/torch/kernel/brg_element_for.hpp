...
class BRGIteratorTensor {
  ...
  public:
    BRGIteratorTensor(hb_tensor_t* t, uint32_t start_loc = 0) :
      N(t->N),
      dims(t->dims),
...
// __attribute__ ((noinline))  int tensorlib_add(hb_tensor_t* c_p,
//                                               hb_tensor_t* a_p,
//                                               hb_tensor_t* b_p,
//                                               float* alpha) {
...
inline void brg_elementwise_for(hb_tensor_t* _t0, hb_tensor_t* _t1,
                                 hb_tensor_t* _t2, FetchFunctor functor) {
  //--------------------------------------------------
...
template <class FetchFunctor>
inline void brg_elementwise_for(hb_tensor_t* _t0,
                                 FetchFunctor functor) {
  //--------------------------------------------------
  // get the type of frist argument of lambda function
  //-------------------------------------------------
...
template <class FetchFunctor>
inline void brg_tile_elementwise_for(hb_tensor_t* _t0, hb_tensor_t* _t1,
                                      hb_tensor_t* _t2, FetchFunctor functor) {
  //--------------------------------------------------
  // get the type of frist argument of lambda function
  //-------------------------------------------------
...
template <class FetchFunctor>
inline void brg_tile_elementwise_for(hb_tensor_t* _t0,
                                      FetchFunctor functor) {
  //--------------------------------------------------
  // get the type of frist argument of lambda function
  //-------------------------------------------------
