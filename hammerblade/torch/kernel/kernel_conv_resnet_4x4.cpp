...
extern "C" {
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_4x4(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_4x4_back_input(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
  ...
  __attribute__ ((noinline))  int tensorlib_conv_resnet_32_3x3_4x4_back_weight(
    hb_tensor_t* output,
    hb_tensor_t* input,
    hb_tensor_t* weight,
    hb_vector_t* padding,
  ...
  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_4x4, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)

  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_4x4_back_input, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)

  HB_EMUL_REG_KERNEL(tensorlib_conv_resnet_32_3x3_4x4_back_weight, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*,
                     hb_vector_t*, hb_vector_t*)
