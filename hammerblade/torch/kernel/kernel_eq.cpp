...
extern "C" {
  ...
  __attribute__ ((noinline))  int tensorlib_eq_Float(
          hb_tensor_t* t0_p,
          hb_tensor_t* t1_p,
          hb_tensor_t* t2_p) {
  ...
  __attribute__ ((noinline))  int tensorlib_eq_Int(
          hb_tensor_t* t0_p,
          hb_tensor_t* t1_p,
          hb_tensor_t* t2_p) {
    HBTensor<bool> out(t0_p);
  ...
  HB_EMUL_REG_KERNEL(tensorlib_eq_Float, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*)
  HB_EMUL_REG_KERNEL(tensorlib_eq_Int, hb_tensor_t*, hb_tensor_t*, hb_tensor_t*)
}
